  ...
  return (
    <header className="flex items-center justify-between px-4 h-16 bg-neutral-900 border-b border-neutral-800 shadow-sm flex-shrink-0">
      <div className="flex items-center gap-3">
        <h1 className="text-xl font-bold text-orange-500 tracking-wider">PROMPT BUILDER</h1>
      </div>
      <div className="flex items-center gap-2">
        ...
        <div
          className="w-9 h-9 bg-neutral-700 rounded-full flex items-center justify-center text-neutral-400"
          title="User"
        >
